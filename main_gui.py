...
def custom_sim_window():
    ...
    def exit_button_pushed():
        global cutom_sim
        cutom_sim.destroy()  # Kill the cutom_sim window
    ...
    # Credits button
    credits_button = tk.Button(cutom_sim,text="Credits",command=credits_msg,font=("Arial Bold",50))

    # Help button
    help_button = tk.Button(cutom_sim,text="Help",command=helpmsg,font=("Arial Bold",50))

    # Exit button
    exit_button = tk.Button(cutom_sim, text = "Exit", command = exit_button_pushed , font=("Arial Bold",50))
